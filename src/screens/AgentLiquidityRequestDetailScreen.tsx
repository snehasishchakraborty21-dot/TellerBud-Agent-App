  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 py-3.5 space-y-3.5">
        ...
        {isConnectionIssue && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 shadow-2xs space-y-2">
          ...
          <div className="bg-white border border-blue-100 rounded-2xl p-4 shadow-2xs space-y-3 relative overflow-hidden">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <div className="w-7.5 h-7.5 rounded-xl bg-blue-50 text-[#0052CC] flex items-center justify-center shrink-0">
      ...
      {/* 6. Sticky Bottom Action Controls & True Footer */}
      <footer className="bg-white border-t border-slate-200/90 px-4 pt-3 pb-2.5 shadow-lg shrink-0 z-10 space-y-2.5">
        {effectiveStatus === 'matched' && (
          <button
        ...
        {effectiveStatus === 'timed_out' && (
          <div className="space-y-2">
            ...
            <button
              onClick={onBackToRequests || onBack}
              className="w-full py-2.5 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold flex items-center justify-center transition-colors cursor-pointer"
            >
              <span>Back to Requests</span>
            </button>
          </div>
        ...
        {/* Footer positioned below Back to Requests and above safe area */}
